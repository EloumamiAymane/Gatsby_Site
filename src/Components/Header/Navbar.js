...
return (
 ...
 <nav class="main-menu navbar-expand-md navbar-light" id='x'>
    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
        <ul class="navigation clearfix">
            <li id="menu-item-15"
                ...
                <a title="Home" href="#" data-toggle="dropdown1" class="hvr-underline-from-left1" aria-expanded="false"
                    data-scroll="" data-options="easing: easeOutQuart">Nos Missions </a>
                        ...
                        <ul role="menu" class="submenu">
                            ...
                            <li id="menu-item-472"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-472"><a
                                    title="Header Style Two"
                                    href="https://naxly.wpcomstaging.com/artificial-intelligence/">Header Style Two</a>
                            </li>
                            <li id="menu-item-471"
                            ...
                            <li id="menu-item-470"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-470"><a
                                    ...
                                    href="https://naxly.wpcomstaging.com/business-intelligence/">Header Style Four</a>
                            </li>
                            <li id="menu-item-469"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-469"><a
                                    title="Header Style Five"
                                    href="https://naxly.wpcomstaging.com/user-analysis/">Header Style Five</a></li>
                        </ul>
          ...
          <li id="menu-item-354"
            ...
            <li id="menu-item-356"
                ...
                <a title="Blog" href="#" data-toggle="dropdown1" class="hvr-underline-from-left1" aria-expanded="false"
                    data-scroll="" data-options="easing: easeOutQuart">Carrière Professionnel</a>
                {/* <ul role="menu" class="submenu">
                    <li id="menu-item-595"
                        ...
                        <ul role="menu" class="submenu">
                            <li id="menu-item-736"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-736"><a
                                    title="Service 01" href="https://naxly.wpcomstaging.com/service-01/">Service 01</a>
                            </li>
                            <li id="menu-item-742"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-742"><a
                                    title="Service 02" href="https://naxly.wpcomstaging.com/service-02/">Service 02</a>
                            </li>
                            <li id="menu-item-754"
                        ...
                        <ul role="menu" class="submenu">
                            ...
                            <li id="menu-item-803"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-803"><a
                                    title="Skills 01" href="https://naxly.wpcomstaging.com/skills-01/">Skills 01</a>
                            </li>
                            <li id="menu-item-807"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-807"><a
                                    title="Skills 02" href="https://naxly.wpcomstaging.com/skills-02/">Skills 02</a>
                            </li>
                            <li id="menu-item-810"
                        ...
                        <ul role="menu" class="submenu">
                            <li id="menu-item-834"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-834"><a
                                    title="Fun Fact 01" href="https://naxly.wpcomstaging.com/fun-fact-01/">Fun Fact
                                    01</a></li>
                            <li id="menu-item-842"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-842"><a
                                    title="Fun Fact 02" href="https://naxly.wpcomstaging.com/fun-fact-02/">Fun Fact
                                    02</a></li>
                            <li id="menu-item-841"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-841"><a
                                    title="Fun Fact 03" href="https://naxly.wpcomstaging.com/fun-fact-03/">Fun Fact
                                    03</a></li>
                            <li id="menu-item-845"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-845"><a
                                    title="Fun Fact 04" href="https://naxly.wpcomstaging.com/fun-fact-04/">Fun Fact
                                    04</a></li>
                            <li id="menu-item-858"
                        ...
                        <ul role="menu" class="submenu">
                            ...
                            <li id="menu-item-922"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-922"><a
                                    title="Technology" href="https://naxly.wpcomstaging.com/technology/">Technology</a>
                            </li>
                        </ul>
                        <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>
                    </li>
            ...
            <li >
                <button class="BTnTouch">Join Us</button>
