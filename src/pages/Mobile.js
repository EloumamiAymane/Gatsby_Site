                            ...
                            <li id="menu-item-15"
                                ...
                                <ul role="menu" class="submenu">
                                    <li id="menu-item-14"
                                        ...
                                        <a title="Data Science" href="https://naxly.wpcomstaging.com/">Data Science</a>
                                    </li>
                                    <li id="menu-item-117"
                                    ...
                                    <li id="menu-item-273"
                                        ...
                                        <a title="User Analysis"
                                            href="https://naxly.wpcomstaging.com/user-analysis/">User Analysis</a></li>
                                    <li id="menu-item-361"
                                    ...
                                    <li id="menu-item-1242"
                                        ...
                                        <a title="Chatbot" href="https://naxly.wpcomstaging.com/chatbot/">Chatbot</a>
                                    </li>
                                    <li id="menu-item-1342"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1342">
                                        <a title="Mobile App" href="https://naxly.wpcomstaging.com/mobile-app/">Mobile
                                            App</a></li>
                                    ...
                                    <li id="menu-item-941"
                                        ...
                                        <a title="Home RTL" href="https://naxly.wpcomstaging.com/home-rtl/">Home RTL</a>
                                    </li>
                                    <li id="menu-item-940"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-940">
                                        <a title="Home OnePage" href="https://naxly.wpcomstaging.com/home-onepage/">Home
                                            OnePage</a></li>
                                    <li id="menu-item-467"
                                ...
                                <ul role="menu" class="submenu">
                                    <li id="menu-item-482"
                                        ...
                                        <a title="About Company"
                                            href="https://naxly.wpcomstaging.com/about-company/">About Company</a></li>
                                    <li id="menu-item-500"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-500">
                                        <a title="Meet Our Team"
                                            href="https://naxly.wpcomstaging.com/meet-our-team/">Meet Our Team</a></li>
                                    <li id="menu-item-511"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-511">
                                        <a title="Get In Touch" href="https://naxly.wpcomstaging.com/get-in-touch/">Get
                                            In Touch</a></li>
                                </ul>
                                <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>
                            </li>
                            <li id="menu-item-354"
                                ...
                                <ul role="menu" class="submenu">
                                    <li id="menu-item-525"
                                        ...
                                        <a title="Our Services" href="https://naxly.wpcomstaging.com/our-services/">Our
                                            Services</a></li>
                                    <li id="menu-item-703"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-703">
                                        <a title="Service Details"
                                            href="https://naxly.wpcomstaging.com/service-details/">Service Details</a>
                                    </li>
                                </ul>
                                <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>
                            </li>
                            <li id="menu-item-355"
                                ...
                                <ul role="menu" class="submenu">
                                    ...
                                    <li id="menu-item-588"
                                        ...
                                        <a title="Case Studies" href="https://naxly.wpcomstaging.com/case-studies/">Case
                                            Studies</a></li>
                                ...
                                <ul role="menu" class="submenu">
                                    <li id="menu-item-595"
                                        ...
                                        <a title="Classic Grid"
                                            href="https://naxly.wpcomstaging.com/classic-grid/">Classic Grid</a></li>
                                    <li id="menu-item-623"
                                    ...
                                    <li id="menu-item-632"
                                        ...
                                        <a title="Modern With S/B"
                                            href="https://naxly.wpcomstaging.com/modern-with-s-b/">Modern With S/B</a>
                                    </li>
                                    <li id="menu-item-933"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-933"><a
                                            title="Single Post"
                                            href="http://el.commonsupport.com/newwp/naxly/?p=667">Single Post</a></li>
                                </ul>
                                <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>
                            </li>
                            <li id="menu-item-357"
                                    ...
                                    <li id="menu-item-833"
                                        ...
                                        <ul role="menu" class="submenu">
                                            <li id="menu-item-834"
                                                ...
                                                <a title="Fun Fact 01"
                                                    href="https://naxly.wpcomstaging.com/fun-fact-01/">Fun Fact 01</a>
                                            </li>
                                            <li id="menu-item-842"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-842">
                                                <a title="Fun Fact 02"
                                                    href="https://naxly.wpcomstaging.com/fun-fact-02/">Fun Fact 02</a>
                                            </li>
                                            <li id="menu-item-841"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-841">
                                                <a title="Fun Fact 03"
                                                    href="https://naxly.wpcomstaging.com/fun-fact-03/">Fun Fact 03</a>
                                            </li>
                                            <li id="menu-item-845"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-845">
                                                <a title="Fun Fact 04"
                                                    href="https://naxly.wpcomstaging.com/fun-fact-04/">Fun Fact 04</a>
                                            </li>
                                            <li id="menu-item-858"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-858">
                                                <a title="News 01" href="https://naxly.wpcomstaging.com/news-01/">News
                                                    01</a></li>
                                            <li id="menu-item-857"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-857">
                                                <a title="News 02" href="https://naxly.wpcomstaging.com/news-02/">News
                                                    02</a></li>
                                            <li id="menu-item-856"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-856">
                                                <a title="News 03" href="https://naxly.wpcomstaging.com/news-03/">News
                                                    03</a></li>
                                            <li id="menu-item-855"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-855">
                                                <a title="News 04" href="https://naxly.wpcomstaging.com/news-04/">News
                                                    04</a></li>
                                        </ul>
                                        <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>
                                    </li>
                            ...
                            <li id="menu-item-358"
                                ...
                                <ul role="menu" class="submenu">
                                    ...
                                    <li id="menu-item-675"
                                        ...
                                        <a title="Coming Soon" href="https://naxly.wpcomstaging.com/coming-soon/">Coming
                                            Soon</a></li>
                                    <li id="menu-item-676"
